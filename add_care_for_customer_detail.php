...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['addUser'])) {
  ...
  $userAdd = $klient->addcustomcaretype($_POST);
}
            ...
            <div class="ps-3">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0 align-items-center">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Pridaj Starostlivosť pre klienta <b> <?php echo $klient->selectClientName($clientid); ?></b></li>
                </ol>
              </nav>
            </div>
          ...
          <div class="row">
            ...
            <form class="" action="" method="post">
               <input type="hidden" name="client_id" value="<?php echo $clientid; ?>">
                ...
                <label for="sel_care">Vyberte úkon</label>
                ...
                <div class="form-group pt-3">
                  <label for="link">Dátum úkonu</label>
                  <input class="result form-control" type="datetime-local" id="date-time" >
                </div>
                <div class="form-group pt-3">
