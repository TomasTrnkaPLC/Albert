...
<strong>Error !</strong> Email already Exists, please try another Email... !</div>';
  ...
  public function addNewUserByAdmin($data){
    ...
    if ($name == "" || $username == "" || $email == "" || $mobile == "" || $adress == "") {
...
// Select Role
  ...
  public function selectAllUserData(){
    $sql = "SELECT * FROM tbl_recepcia ORDER BY id DESC";
    $stmt = $this->db->pdo->prepare($sql);
    $stmt->execute();
  ...
  <strong>Error !</strong> Žiadna emailova adresa sa nenašla!</div>';
        ...
        if ($chkActive == TRUE) {
          $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg" style=" z-index: 20;">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    <strong>Error !</strong> Váš účet bol deaktivovaný!</div>';
            return $msg;
        }elseif ($logResult) {
          ...
          Session::set('logMsg', '<div class="alert alert-Hotovo alert-dismissible mt-3" id="flash-msg" style=" z-index: 20;">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
